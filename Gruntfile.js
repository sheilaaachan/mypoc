                ...
                files: [
                    {
                        ...
                        src: [
                            ...
                            "styles/img/**/*",
                            "styles/ui/images/*",
                            "modules/pages/**/**/views/*.html",
                            "modules/shared/layout/views/*.html",
                            "modules/shared/i18n/translations/*.json",
                            "modules/shared/elements/modalDelete/myModalContent.html"
                        ]
                    }, {
                        expand: true,
                        cwd: ".tmp",
